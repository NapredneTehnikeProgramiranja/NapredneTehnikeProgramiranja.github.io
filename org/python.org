...
** TextX
   [[https://github.com/igordejanovic/textX][TextX]] je Python meta jezik za definisanje jezika inspirisan
   [[http://www.eclipse.org/Xtext/][XText]]-om.

** Zadaci

   *ParenPy*

   #+INCLUDE: "examples/example.plisp" src python :eval no

   Gramatika

   #+INCLUDE: "examples/plisp.tx" src textx

   #+INCLUDE: "examples/plisp.py" src python :eval no
